...
namespace DataPlatformSI.Services.Identity
{
    ...
    public class TokenValidatorService : ITokenValidatorService
    {
        ...
        public TokenValidatorService(IApplicationUserManager userManager, ITokenStoreService tokenStoreService)
        {
        ...
        public async Task ValidateAsync(TokenValidatedContext context)
        {
            ...
            await _userManager.UpdateUserLastActivityDateAsync(userId);
        }
    }
}